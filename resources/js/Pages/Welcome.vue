								...
								<div class="card-body border-right border-bottom p-3 h-100">
									<div class="d-flex flex-row bd-highlight pt-2">
										...
										<div class="ps-3">
											...
											<p class="text-muted small">Laravel has wonderful, thorough documentation covering every aspect of the framework. Whether you are new to the framework or have previous experience with Laravel, we recommend reading all of the documentation from beginning to end.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="card-body border-bottom p-3 h-100">
									<div class="d-flex flex-row bd-highlight pt-2">
										...
										<div class="ps-3">
											...
											<p class="text-muted small">Laracasts offers thousands of video tutorials on Laravel, PHP, and JavaScript development. Check them out, see for yourself, and massively level up your development skills in the process.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="card-body border-right p-3 h-100">
									<div class="d-flex flex-row bd-highlight pt-2">
										...
										<div class="ps-3 text-sm">
											...
											<p class="text-muted small">Laravel News is a community driven portal and newsletter aggregating all of the latest and most important news in the Laravel ecosystem, including new package releases and tutorials.</p>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="d-flex justify-content-between mt-3">
						<div class="text-sm text-muted">
							<div class="flex align-content-center">
								...
								<a href="https://laravel.bigcartel.com" class="text-muted"> Shop </a>
								...
								<a href="https://github.com/sponsors/taylorotwell" class="text-muted"> Sponsor </a>
							</div>
						</div>

						<div class="text-sm text-muted">Laravel v{{ laravelVersion }} (PHP v{{ phpVersion }})</div>
					</div>
				</div>
			</div>
		</div>
